...
public class SwayNBobController : MonoBehaviour
{
    ...
    private void Awake()
    {
        initialPos = new Vector3(0 , 0 , 1.5f);
    }
    ...
    void BobOffset()
    {
        speedCurve += Time.deltaTime * (playerController.isGrounded ? playerController.velocity.magnitude : 1f) + 0.01f;
